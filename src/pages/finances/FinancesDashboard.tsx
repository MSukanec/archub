...
import { MonthlyFlowChart } from '@/components/graphics/finances/MonthlyFlowChart'
import { WalletBalanceChart } from '@/components/graphics/finances/WalletBalanceChart'
