...
import { MonthlyFlowChart } from '@/components/ui-custom/charts/MonthlyFlowChart'
import { WalletBalanceChart } from '@/components/ui-custom/charts/WalletBalanceChart'
import { ExpensesByCategoryChart } from '@/components/ui-custom/charts/ExpensesByCategoryChart'
import { MiniTrendChart } from '@/components/ui-custom/charts/MiniTrendChart'
  ...
  return (
    <Layout headerProps={headerProps} wide={true}>
      <div className="space-y-6">
        ...
        {/* Segunda Fila: Métricas (1 col) + Gráfico de Flujo Financiero (3 cols) */}
        <div className="hidden md:grid grid-cols-4 gap-4 lg:gap-6">
          ...
          {/* Gráfico de Flujo Financiero - ocupa 3 columnas */}
