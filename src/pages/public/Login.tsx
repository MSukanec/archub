...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex" style={{ backgroundColor: 'var(--sidebar-bg)' }}>
      {/* Left Panel - Dark */}
      ...
      {/* Right Panel - Light */}
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 lg:p-12" style={{ backgroundColor: 'var(--layout-bg)' }}>
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="px-2 bg-[var(--layout-bg)] text-gray-500">O continúa con</span>
                </div>
              </div>
