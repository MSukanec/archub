  ...
  return (
    <Layout headerProps={headerProps}>
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {/* Preferencias Avanzadas Section */}
        <div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Left Column - Title and Description */}
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-lg font-semibold">Preferencias Avanzadas</h3>
              </div>
              <p className="text-sm text-muted-foreground">
                Configuraciones avanzadas para personalizar el comportamiento del sistema.
              </p>
            </div>

            {/* Right Column - Advanced Preferences */}
            <div className="space-y-4">
              {/* Hide system concepts checkbox */}
              <div className="flex items-start gap-3 p-4 border border-gray-200 dark:border-gray-700 rounded-md">
                <Checkbox
                  id="hide-system-concepts"
                  checked={false}
                  onCheckedChange={() => {}}
                />
                <div className="space-y-1">
                  <Label htmlFor="hide-system-concepts" className="text-sm font-medium">
                    Ocultar conceptos de sistema en movimientos de finanzas
                  </Label>
                  <p className="text-xs text-muted-foreground">
                    Cuando esté habilitado, solo se mostrarán los conceptos personalizados de tu organización en los movimientos financieros.
                  </p>
                </div>
              </div>
            </div>
