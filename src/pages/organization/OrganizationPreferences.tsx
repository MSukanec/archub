...
export default function OrganizationPreferences() {
  ...
  const createConceptMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ['movement-concepts', organizationId] });
    },
    onError: (error) => {
  ...
  const getOrganizationConcepts = () => {
    return movementConcepts.filter(concept => concept.organization_id === organizationId);
  };
