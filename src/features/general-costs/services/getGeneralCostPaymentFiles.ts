 ...
 * 
 * CRÍTICO: Filtra por general_cost_payment_id Y organization_id para prevenir data leaks.
 * 
 * @param paymentId - ID del pago de gasto general
 * @param organizationId - ID de la organización
 * @returns Array de archivos multimedia, o array vacío
 * @throws {Error} Si falla la query de Supabase
 */
export async function getGeneralCostPaymentFiles(paymentId: string, organizationId: string): Promise<GeneralCostPaymentFile[]> {
