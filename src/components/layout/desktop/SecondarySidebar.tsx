...
export function SecondarySidebar() {
  ...
  return (
    <aside 
      className={cn(
        "fixed top-12 left-[40px] h-[calc(100vh-3rem)] border-r bg-[var(--main-sidebar-bg)] border-[var(--main-sidebar-border)] transition-all duration-300 z-40 flex flex-col",
