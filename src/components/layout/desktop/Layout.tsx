        ...
        >
          ...
          >
            {headerProps ? (
              ...
              >
                <div
                  className={`${wide ? "" : "max-w-[1440px] mx-auto"} px-18 py-6 pb-32 h-full overflow-auto`}
                >
                  {children}
                </div>
              </PageLayout>
              ...
              <div
                className={`${wide ? "" : "max-w-[1440px] mx-auto"} px-4 py-3 md:px-18 md:py-6 pb-32 h-full overflow-auto`}
              >
                {children}
              </div>
            )}
