      ...
      <div className="p-1">
        <div className="flex justify-center w-full">
          <div className={cn(
            ...
            {isExpanded ? (
              <div className={cn(
                "w-full border-2 rounded-lg p-3 bg-white transition-all duration-500 ease-out",
                ...
                <div className="flex items-center gap-2 mb-2 opacity-0 animate-[fadeInUp_0.4s_ease-out_0.2s_forwards]">
                  <div className="w-5 h-5 rounded-full border-2 bg-white flex items-center justify-center transition-all duration-300">
                ...
                <div className="mb-2 opacity-0 animate-[fadeInUp_0.4s_ease-out_0.3s_forwards]">
                  <span className={cn(
                ...
                <p className="text-xs text-gray-500 mb-3 opacity-0 animate-[fadeInUp_0.4s_ease-out_0.4s_forwards]">
                ...
                {(!userData?.plan || userData.plan.name?.toLowerCase() === 'free') && (
                  <button className="w-full py-2 px-3 rounded-lg text-xs font-medium bg-blue-600 text-white hover:bg-blue-700 flex items-center justify-center gap-1 transition-all duration-200 opacity-0 animate-[fadeInUp_0.4s_ease-out_0.5s_forwards]">
