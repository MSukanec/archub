      ...
      <div className="p-1">
        <div className="flex justify-center w-full">
          <div className={cn(
            ...
            {isExpanded ? (
              <div className={cn(
                "w-full border-2 rounded-lg p-3 transition-all duration-200 ease-out",
                (!userData?.plan || userData.plan.name?.toLowerCase() === 'free') && "bg-gray-50 border-[var(--accent)]",
                userData?.plan?.name?.toLowerCase() === 'pro' && "bg-blue-50 border-blue-500",
                userData?.plan?.name?.toLowerCase() === 'teams' && "bg-purple-50 border-purple-500"
              )}>
                <div className="flex items-center gap-2 mb-2 opacity-0 animate-[fadeInUp_0.15s_ease-out_0.05s_forwards]">
                  <div className={cn(
                    "w-5 h-5 rounded-full border-2 flex items-center justify-center transition-all duration-150",
                    (!userData?.plan || userData.plan.name?.toLowerCase() === 'free') && "bg-[var(--accent)] border-[var(--accent)]",
                    userData?.plan?.name?.toLowerCase() === 'pro' && "bg-blue-500 border-blue-500",
                    userData?.plan?.name?.toLowerCase() === 'teams' && "bg-purple-500 border-purple-500"
                  )}>
                ...
                <div className="mb-2 opacity-0 animate-[fadeInUp_0.15s_ease-out_0.1s_forwards]">
                  <span className={cn(
                ...
                <p className="text-xs text-gray-500 mb-3 opacity-0 animate-[fadeInUp_0.15s_ease-out_0.15s_forwards]">
                ...
                {(!userData?.plan || userData.plan.name?.toLowerCase() === 'free') && (
                  <button className="w-full py-2 px-3 rounded-lg text-xs font-medium bg-blue-600 text-white hover:bg-blue-700 flex items-center justify-center gap-1 transition-all duration-150 opacity-0 animate-[fadeInUp_0.15s_ease-out_0.2s_forwards]">
              ...
              <div className={cn(
                "w-8 h-8 rounded-full border-2 flex items-center justify-center cursor-pointer transition-all duration-200 ease-out hover:scale-105",
                (!userData?.plan || userData.plan.name?.toLowerCase() === 'free') && "bg-[var(--accent)] border-[var(--accent)]",
                userData?.plan?.name?.toLowerCase() === 'pro' && "bg-blue-500 border-blue-500",
                userData?.plan?.name?.toLowerCase() === 'teams' && "bg-purple-500 border-purple-500"
              )}>
