...
import { ContactTypeModal } from '@/features/contacts/modals/ContactTypeModal';
...
export function initializeModalRegistry(): void {
  ...
  registerModal('contactType', ContactTypeModal as any, { 
    ...generalConfig, 
    size: 'sm',
    mapDataToProps: (data) => ({
      modalData: {
  ...
  registerModal('payment', AdminPaymentsModal as any, financeConfig);
