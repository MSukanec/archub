    ...
    <div className="space-y-4">
      {!loadingReady ? (
        ...
        <>
          ...
          {!editingMovement && (
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-3 gap-2">
                ...
                <Button
                  type="button"
                  variant={movementType === 'aportes' ? 'default' : 'outline'}
                  onClick={() => setMovementType('aportes')}
                  className="h-auto py-3 px-4"
                >
                  <div className="text-center">
                    <div className="font-medium">Aportes</div>
                    <div className="text-xs text-muted-foreground">De clientes</div>
                  </div>
                </Button>
                <Button
                  type="button"
                  variant={movementType === 'aportes_propios' ? 'default' : 'outline'}
                  onClick={() => setMovementType('aportes_propios')}
                  className="h-auto py-3 px-4"
                >
                  <div className="text-center">
                    <div className="font-medium">Aportes Propios</div>
                    <div className="text-xs text-muted-foreground">Capital propio</div>
                  </div>
                </Button>
                <Button
                  type="button"
                  variant={movementType === 'retiros_propios' ? 'default' : 'outline'}
                  onClick={() => setMovementType('retiros_propios')}
                  className="h-auto py-3 px-4"
                >
                  <div className="text-center">
                    <div className="font-medium">Retiros Propios</div>
                    <div className="text-xs text-muted-foreground">Retiro capital</div>
                  </div>
                </Button>
              </div>
            </div>
          ...
          {/* Formularios basados en el tipo seleccionado */}
        ...
        <div className="text-center py-8">
          <div className="text-muted-foreground">Selecciona un tipo de movimiento para continuar</div>
        </div>
      )}
        </>
      )}
