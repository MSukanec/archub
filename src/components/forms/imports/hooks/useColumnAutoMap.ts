...
const DEFAULT_SMART_MAPPING: Record<string, string[]> = {
  ...
  date: ['fecha', 'date', 'movement_date', 'created_at', 'fechadepago', 'fecha de pago', 'fecha pago'],
  currency_id: ['moneda', 'currency', 'fiat', 'divisa', 'monedacódigo', 'moneda código'],
  wallet_id: ['billetera', 'wallet', 'cuenta', 'account'],
  client_id: ['cliente', 'client', 'nombre cliente', 'cliente nombre', 'clientenombre'],
  ...
  exchange_rate: ['cotizacion', 'cotización', 'tasa', 'rate', 'cambio', 'cotizacionfinal', 'cotización final'],
