...
const DEFAULT_SMART_MAPPING: Record<string, string[]> = {
  ...
  amount: ['cantidad', 'monto', 'importe', 'total', 'valor', 'price', 'precio'],
  date: ['fecha', 'date', 'movement_date', 'created_at'],
  currency_id: ['moneda', 'currency', 'fiat', 'divisa'],
  ...
  exchange_rate: ['cotizacion', 'cotización', 'tasa', 'rate', 'cambio'],
