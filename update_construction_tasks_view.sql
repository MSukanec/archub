-- Actualizar vista construction_tasks_view para incluir division_name
-- Este archivo debe ejecutarse en la base de datos para arreglar el problema del rubro faltante
...
SELECT
  ...
  td.name as division_name,                -- task_divisions.name (via tasks.task_division_id) - ESTE ES EL CAMPO QUE FALTABA
...
LEFT JOIN public.task_divisions td          -- ESTE ES EL JOIN QUE FALTABA
