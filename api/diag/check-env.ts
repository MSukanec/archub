...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  try {
    ...
    try {
      const { extractToken, requireUser } = await import('../_lib/auth-helpers.js');
    ...
    try {
      const { getOrganizationMembers } = await import('../_lib/handlers/organization/getOrganizationMembers.js');
