-- UPDATE project_data with new image metadata
-- Esta query actualiza la metadata de las 25 imágenes migradas

UPDATE project_data SET 
  image_bucket = 'social-assets',
  image_path = 'projects/' || organization_id || '/' || project_id || '/gallery/' || 
               CASE 
