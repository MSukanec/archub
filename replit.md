...
- **Project Management Features**: Includes a custom-built React-based Gantt chart with optimistic updates, a full Kanban board system with drag & drop, and a system for generating parametric tasks. Budget management features comprehensive FASES support with two-row header structure (phase names above, column headers below), default "General" phase, and integrated add task functionality.
