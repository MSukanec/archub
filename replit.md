...
- **Onboarding Optimization (2025-08-07)**: Streamlined onboarding process from 3 steps to 2 steps by eliminating Step3Discovery.tsx. Now consists of: Step 1 (User Data) and Step 2 (Financial Setup + Organization). Removed unnecessary fields like country, birthdate, discovered_by to minimize required information and improve user experience. Step2FinancialSetup now serves as the final step with "Finalizar configuración" button.
