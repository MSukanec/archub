...
- **TASKS Module**: Consolidated feature in `src/features/tasks/` with barrel exports. Contains 18 hooks, 8 modals, 15 components, 3 views (TaskBasicDataView, TaskCostsView, TasksView). Pattern reference: GENERAL-COSTS feature.
